...
public class PdfViewFact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pdfviewfact);
        ...
        new PdfLeer(pdfView,progressBar).execute(AdapterServiciosXmascota.ordenid);
    }
